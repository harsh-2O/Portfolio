...
const NavLink = styled.a<{ active?: boolean }>`
  ...
  &:hover {
    color: ${props => props.active ? 'var(--nav-bg)' : 'rgba(255, 255, 255, 0.8)'};
  }
...
const HamburgerButton = styled.button`
  ...
  span {
    ...
    transition: transform 0.3s ease, opacity 0.3s ease, background-color var(--transition);
...
const TestimonialQuote = styled(motion.p)`
  ...
  background: linear-gradient(135deg, var(--text-primary) 18.5%, rgba(100, 100, 100, 0.7) 100%);
...
const Home = () => {
  ...
  useEffect(() => {
    const texts = ["UI/UX Designer", "Solver", "Mobile Developer", "Aspiring ML Engineer"];
    let currentIndex = 0;

    if (titleSpan1Ref.current) titleSpan1Ref.current.style.visibility = 'visible';
    if (plusSignRef.current) plusSignRef.current.style.visibility = 'visible';
    if (changingTextRef.current) changingTextRef.current.style.visibility = 'visible';
    if (contactInfoRef.current) contactInfoRef.current.style.visibility = 'visible';
    if (descriptionRef.current) descriptionRef.current.style.visibility = 'visible';

    gsap.set([titleSpan1Ref.current, plusSignRef.current, changingTextRef.current], {
    ...
    const updateScrollIndicators = () => {
      if (scrollIndicatorRef.current && scrollToTopRef.current && scrollTextRef.current) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const mainSectionTop = mainSectionEl?.getBoundingClientRect().top || 0;
      const resumeSectionTop = resumeSectionEl?.getBoundingClientRect().top || 0;
      const projectsSectionTop = projectsSectionEl?.getBoundingClientRect().top || 0;
      const footerSectionTop = footerSectionEl?.getBoundingClientRect().top || 0;
    ...
    <Container>
      <HeaderContainer>
        ...
        <Navigation isOpen={isMenuOpen}>
          ...
          >
            <ProjectCountBadge theme={isDarkMode ? 'dark' : 'light'}>{projects.length}</ProjectCountBadge>
            Projects
          </NavLink>
          <NavLink 
      ...
      <MainContent id="main-section">
        ...
        <ContactSection>
          ...
          <Description ref={descriptionRef}>
            Hello, I'm Harsh, an online Fullstack developer focusing on brand identity, 
            user experience, and ai focus softwares.
          </Description>
        </ContactSection>
      </MainContent>
      ...
      <DescriptionSection ref={techSectionRef} id="tech-section">
        ...
        <TechGrid>
          <TechItem>
            <img className="icon-normal" src={javascriptIcon} alt="JavaScript" loading="lazy" width="60" height="60" />
            <img className="icon-colored" src={javascriptColorIcon} alt="JavaScript" loading="lazy" width="60" height="60" />
          </TechItem>
          <TechItem>
            <img className="icon-normal" src={reactIcon} alt="React" loading="lazy" width="60" height="60" />
            <img className="icon-colored" src={reactColorIcon} alt="React" loading="lazy" width="60" height="60" />
          </TechItem>
          <TechItem>
            <img className="icon-normal" src={flutterIcon} alt="Flutter" loading="lazy" width="60" height="60" />
            <img className="icon-colored" src={flutterColorIcon} alt="Flutter" loading="lazy" width="60" height="60" />
          </TechItem>
          <TechItem>
            <img className="icon-normal" src={nodeJsIcon} alt="Node.js" loading="lazy" width="60" height="60" />
            <img className="icon-colored" src={nodeJsColorIcon} alt="Node.js" loading="lazy" width="60" height="60" />
          </TechItem>
          <TechItem>
            <img className="icon-normal" src={googleCloudIcon} alt="Google Cloud" loading="lazy" width="60" height="60" />
            <img className="icon-colored" src={googleCloudColorIcon} alt="Google Cloud" loading="lazy" width="60" height="60" />
          </TechItem>
          <TechItem>
            <img className="icon-normal" src={firebaseIcon} alt="Firebase" loading="lazy" width="60" height="60" />
            <img className="icon-colored" src={firebaseColorIcon} alt="Firebase" loading="lazy" width="60" height="60" />
          </TechItem>
          <TechItem>
            <img className="icon-normal" src={pythonIcon} alt="Python" loading="lazy" width="60" height="60" />
            <img className="icon-colored" src={pythonColorIcon} alt="Python" loading="lazy" width="60" height="60" />
          </TechItem>
          <TechItem>
            <img className="icon-normal" src={pandasIcon} alt="Pandas" loading="lazy" width="60" height="60" />
            <img className="icon-colored" src={pandasColorIcon} alt="Pandas" loading="lazy" width="60" height="60" />
          </TechItem>
        </TechGrid>
      </DescriptionSection>
    ...
    >
      ...
      <ScrollingBanner>
        <ScrollingText>
          ...
          Crafting software that's fast, functional, and easy to fall in love with.   
          From wireframes to deploy — I build complete digital experiences.   
          Blending code and content to create brands people remember.   
          Turning complex ideas into simple, intuitive user journeys.   
        </ScrollingText>
      </ScrollingBanner>
        ...
        <AnimatePresence mode="wait">
          {testimonials.length > 0 && (
            <TestimonialWrapper key={testimonials[currentTestimonialIndex].id}>
              ...
              >
                <AuthorName>{testimonials[currentTestimonialIndex].author}</AuthorName>
                <AuthorPosition>{testimonials[currentTestimonialIndex].position}</AuthorPosition>
              </TestimonialAuthor>
            </TestimonialWrapper>
          )}
        </AnimatePresence>
          ...
          {testimonials.map((testimonial, index) => (
            <div
              ...
              style={{
                ...
                height: '10px',
                borderRadius: '50%',
                backgroundColor: index === currentTestimonialIndex 
                  ? 'var(--text-primary)' 
      ...
      <Footer id="footer-section">
        ...
        <FooterBottom>
          ...
          <SocialLinks>
            <SocialLink href="https://github.com/harsh-2O" target="_blank" rel="noopener noreferrer">Github</SocialLink>
            <SocialLink href="https://leetcode.com/u/JamesHiding" target="_blank" rel="noopener noreferrer">LeetCode</SocialLink>
            <SocialLink href="https://www.linkedin.com/in/harsh2o" target="_blank" rel="noopener noreferrer">LinkedIn</SocialLink>
          </SocialLinks>
        </FooterBottom>
      </Footer>
                ...
                .map(project => (
                  <div key={project.id}>
                    ...
                    <CardContent style={{ marginTop: "1.5rem" }}>
                      <CardTitle style={{ fontSize: "2.5rem" }}>{project.title}</CardTitle>
                      <CardSubtitle style={{ fontSize: "1.5rem" }}>{project.subtitle}</CardSubtitle>
